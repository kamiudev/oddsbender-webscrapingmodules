...
# init logging
logger_name = environ.get('basketball_betmgm_url_get_logger', 'basketball_betmgm_url_logger')
# for local logs storage and stdout use DEBUG_FLAG = 1
DEBUG_FLAG = environ.get('URL_LOG_DEBUG_FLAG', 1)
log_level = environ.get('basketball_betmgm_url_log_level', 'WARNING')

logger = get_logger(logger_name, DEBUG_FLAG, log_level)

# other variables
URL = environ.get('basketball_betmgm_url', module_conf.get('URL'))
module_work_duration = str_to_timedelta(environ.get('basketball_betmgm_url_module_work_duration', module_conf.get('module_work_duration')))
update_frequency = str_to_timedelta(environ.get('basketball_betmgm_url_update_frequency', module_conf.get('update_frequency')))
browser = environ.get('basketball_betmgm_url_browser', module_conf.get('browser_url'))
            ...
            if check_game_res:
                ...
                for game_section in games_on_initial_page:
                    ...
                    for rd_url in urls_list:
                        ...
                        saving_result = redisClient.add_url_redis(rd_url, 'betmgm', f'basketball_betmgm_prop_{stream_name}')
